...
def dashboard_old(request, name, version):
    context = {
        'got_product': False,
        'test_cases': [],
        'product': None,
    ...
    return render(request, "test_tracker/dashboard_old.html", context)


def dashboard_table_old(request, name, version):
    context = {
        'got_product': False,
        'test_cases': [],
        'product': None,
    ...
    return render(request, "test_tracker/dashboard_table_old.html", context)


def dashboard_info_old(request, name, version):
    context = {
        'got_product': False,
        'test_cases': [],
        'product': None,
    ...
    return render(request, "test_tracker/dashboard_info_old.html", context)


@login_required
@transaction.atomic
def delete_results_for_date_old(request, name, version, day, month, year):
...
@login_required
@transaction.atomic
def copy_result_to_current_date_old(request, name, version, day, month, year, pk):
    product = Product.objects.get(name=name, version=version)
    date = datetime.datetime(year=year, day=day, month=month)
